...
public class ReplyController {
    ...
    public String replyContentsGET(@RequestParam(name = "reply_no") int reply_no, Model model , HttpSession session
    ,HttpServletRequest request){             //RequestParam을 사용하여 reply_no를 받고 Model값을받아사용한다
    ...
    public String replyContentsPOST(ReplyVO replyVO){                                                         //댓글의 정보를받아 사용한다.
        ...
        return "redirect:"+ referer;                                                                //redirect를 사용하여 바로 list를 호출한다.
    }
